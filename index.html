...
<a class="github-button" href="https://github.com/pyronlaboratory/heroku-integrated-firefox-geckodriver/fork" data-color-scheme="no-preference: dark; light: light; dark: light;" data-icon="octicon-repo-forked" data-size="large" aria-label="Fork pyronlaboratory/heroku-integrated-firefox-geckodriver on GitHub">Fork</a>

<!-- Place this tag where you want the button to render. -->
<a class="github-button" href="https://github.com/pyronlaboratory/heroku-integrated-firefox-geckodriver" data-color-scheme="no-preference: dark; light: light; dark: light;" data-icon="octicon-star" data-size="large" aria-label="Star pyronlaboratory/heroku-integrated-firefox-geckodriver on GitHub">Star</a>

<!-- Place this tag where you want the button to render. -->
<a class="github-button" href="https://github.com/pyronlaboratory/heroku-integrated-firefox-geckodriver/issues" data-color-scheme="no-preference: dark; light: light; dark: light;" data-icon="octicon-issue-opened" data-size="large" aria-label="Issue pyronlaboratory/heroku-integrated-firefox-geckodriver on GitHub">Issue</a>
